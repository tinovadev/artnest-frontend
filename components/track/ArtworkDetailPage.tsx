      ...
      <ScrollArea className="h-screen">
        <div className="pb-8">
          ...
          <div className="px-6 lg:px-12 py-6 max-w-7xl mx-auto">
            {/* Artwork Image */}
            <div className="mb-8">
              <div className="relative rounded-2xl overflow-hidden bg-muted aspect-square max-w-md mx-auto">
                <img 
                  src={artwork.image}
                  alt={artwork.title}
            ...
            {results && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-foreground">Detection Results</h3>
                ...
                <Card className="bg-secondary border-border rounded-2xl p-6">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Verified Thefts</div>
                    </div>
                  </div>
                </Card>
