...
export default function ProcessingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 lg:px-12">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="relative mb-12 mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden bg-muted w-80 h-80 lg:w-96 lg:h-96 mx-auto">
            <img 
        ...
        <div className="text-center">
          <h1 className="text-2xl lg:text-4xl font-pixel font-bold mb-4">
          ...
          {/* Progress indicator */}
          <div className="w-64 lg:w-80 h-2 bg-secondary rounded-full overflow-hidden mx-auto">
            <div 
