  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <ScrollArea className="h-screen">
        {/* Mobile Layout */}
        <div className="lg:hidden flex flex-col min-h-screen px-6 py-12">
          {/* Logo and Branding */}
          ...
          <div className="flex-1 bg-secondary flex flex-col justify-center px-12 xl:px-20">
            <div className="max-w-md mx-auto w-full">
              ...
              <Button
                onClick={handleGoogleLogin}
                disabled={!agreed}
                className="w-full bg-background hover:bg-background/80 text-foreground border-0 rounded-2xl py-6 text-lg font-semibold flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {/* Google Icon */}
                <div className="w-6 h-6 flex items-center justify-center">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
